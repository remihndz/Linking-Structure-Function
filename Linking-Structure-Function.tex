...
\begin{figure}[ht!]
  ...
  \caption{\label{fig:OCTAValidation}Validation of the morphology of virtual vasculatures in the macula against OCTA measurements~\cite{Chu2016,Liu_2021,Ma2021}. Values show the deviation (in \%) from the literature average in healthy eyes. Blue bars show the mean in the cohort. Standard deviation is shown by black bars.}  
\end{figure}
...
\subsubsection{Sensitivity analysis of the structural model}\label{sec:gsa}
...
\subsubsection{Uncertainty quantification of the haemodynamics model}\label{sec:UQ}
...
\subsection{Retinal blood flow is associated with macular morphology}\label{sec:disc-results}
