...
a disk of radius $r_{retina}$ (i.e., the entire computational domain), in a annulus with radii $r_{parafovea}$ and $r_{perifovea}$
...
We assumed that the diameters were those of vessel lumen, which could lead to an overestimate of lumen radii between $15$ and $20\percent$ for larger arteries~\cite{Arichika2016,Damian_2021}.
...
The same effect explains the non-symmetrical changes in total retinal blood flow as $\mathcal R$ is decreased (see Figure~S1). %\ref{fig:sup-UQ-TRBF-MFR-vs-R-OPP}). 
