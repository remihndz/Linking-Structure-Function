...
\begin{abstract}
  \textbf{Purpose:}
  Despite image-based macular microvascular parameters are potent disease biomarkers, their relationship with retinal perfusion remains ambiguous.
  We establish a versatile framework for exploring the interplay between the retinal vasculature structure and function.
  We develop a method to generate virtual vasculatures of the retina from the central retinal vessels down to the macular capillaries.
  Alongside this, we develop a haemodynamics model which tests the associations between vascular morphology, as delineated by optical coherence tomography angiography (OCTA), and retinal perfusion.

  \textbf{Methods:} The method to generate the vasculature is based on the distribution of four clinical parameters pertaining to the dimension and blood pressure of the central retinal vessels, constructive constrained optimisation and Voronoi diagram.
  ...
  % All metrics were in good agreement with ranges of pusblished values.
  Total retinal blood flow was strongly correlated with vessel area density, vessel diameter index, fractal dimension and vessel calibre index.
...
\begin{table}[ht!]
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{*{10}{l}}
      \toprule
      \begin{tabular}[c]{@{}l@{}}$N_{terms}$\\ stage 2\end{tabular} & \begin{tabular}[c]{@{}l@{}}$N_{terms}$ \\ stage 3\end{tabular} & $l_{lim}f_r$ & $\delta$ & $\eta$ & $\gamma$ & $\nu$ & $\theta_{min}$ & \begin{tabular}[c]{@{}l@{}}Neighborhood\\ factor\end{tabular} & \begin{tabular}[c]{@{}l@{}}$N_{seeds}$ \\ SVP\end{tabular} \\ \midrule
      \Range{300}{500}{} & \Range{200}{400}{} & \Range{0.1}{0.9}{} & \Range{0.1}{0.9}{} & \Range{0.2}{0.5}{} & \Range{2}{3}{} & \Range{0}{72}{}  & \Range{0}{5}{}  & \Range{0}{5}{} & \Range{800}{1200}{} \\
      \bottomrule
    \end{tabular}
    }
...
The same effect explains the non-symmetrical changes in total retinal blood flow as $\mathcal R$ is decreased (see Figure~S4). %\ref{fig:sup-UQ-TRBF-MFR-vs-R-OPP}). 
