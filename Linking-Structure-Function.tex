...
\begin{abstract}
  ...
  The correlations between total retinal blood flow and macular flow fraction and vascular morphology are derived as Spearman rank coefficients and uncertainty from input parameters is quantified.cc
...
The method presented in this work relies on several hyperparameters listed in Table~\ref{tab:parameters}.
